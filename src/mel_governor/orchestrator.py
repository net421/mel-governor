...
PIPELINE: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("lenin_governor", ("source_critic", "semantic_mapper", "marx_governor", "engels_governor")),
    ...
    ("mel_council", ("marx_governor", "engels_governor", "lenin_governor", "auxiliary_historian", "auxiliary_economist", "auxiliary_sociologist")),
    ("stalin_governor", ("source_critic", "mel_council")),
    ("hoxha_governor", ("source_critic", "mel_council", "stalin_governor")),
    ("anti_revisionist_council", ("mel_council", "stalin_governor", "hoxha_governor")),
    ("debate_engine", ("mel_council", "anti_revisionist_council", "contradiction_finder")),
    ("confidence_engine", ("source_critic", "debate_engine", "mel_council", "anti_revisionist_council")),
    ("knowledge_graph", ("semantic_mapper", "contradiction_finder", "confidence_engine")),
    ("research_synthesizer", ("mel_council", "anti_revisionist_council", "debate_engine", "confidence_engine")),
